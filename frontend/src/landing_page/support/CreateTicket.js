...
function CreateTicket() {
    return ( 
        ...
        <div className='row p-5 mt-5 mb-3'>
         ...
         <div className='col-4 p-5 mt-2 mb-2'>
            <h4 className=''><i class="fa fa-user-o" aria-hidden="true"></i>
        ...
        <div className='col-4 p-5 mt-2 mb-2'>
            <h4 className=''> <i class="fa fa-outdent" aria-hidden="true"></i>
             Kite
            </h4>
        ...
        <div className='col-4 p-5 mt-2 mb-2'>
            <h4 className=''> <i class="fa fa-money" aria-hidden="true"></i>
             Funds
            </h4>
